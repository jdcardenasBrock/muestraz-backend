                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <div>
                                    <th class="fw-bold">Tipo de Membresia: {{ ($usermembership) ? $usermembership->membershiptype : "" }}</th>
                                </div>
                                
                                <div>
                                    <th class="fw-bold">Fecha de Inicio: {{ ($usermembership) ?  $usermembership->begin_date : "" }}</th>
                                </div>

                                <div>
                                    <th class="fw-bold">Fecha de Final: {{ ($usermembership) ?  $usermembership->end_date : "" }}</th>
                                </div>
                            </div>
                        </div>
                    </div>
