    ...
    <section class="shipment">
      <div class="container">
        <ul class="colorMorado">
          <li><img src="{{ URL::asset('web/img/icons/envio.png')}}" alt="" style="height: 148px; padding-bottom: 25px;">
            <h4 class="colorMorado">Envios Nacionales</h4>
          </li>
          
          <li><img src="{{ URL::asset('web/img/icons/soporte.png')}}" alt="" style="height: 148px; padding-bottom: 25px;">
            <h4 class="colorMorado">Soporte Online 24/7 </h4>
          </li>
          
          <li><img src="{{ URL::asset('web/img/icons/pago.png')}}" alt="" style="height: 148px; padding-bottom: 25px;">
            <h4 class="colorMorado"> Pago 100% Seguro </h4>
          </li>
          
          <li><img src="{{ URL::asset('web/img/icons/compania.png')}}" alt="" style="height: 148px; padding-bottom: 25px;">
    ...
    <section class="home-slide simple-head" style="text-align: center;">
      <div class="container">
        ...
        <div class="single-slide">
          ...
          <!-- Slider Content -->
          <div class="owl-slide">
            <img class="img-responsive" src="{{ URL::asset('web/images/Jet_carrusel.jpg')}}" alt="">
            <!-- Header Text -->
      ...
      <div class="container">
        <div class="intro-sec">
          <div class="center-block">
            ...
            <h4>Existimos porque existen los consumidores “atípicos”, los que no son como todo el mundo. Consumidores
              ...
              <a href="#." class="btn btn-inverse margin-right-20">Comprar Membresia</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          ...
          <div class="acces-ser">
            ...
            <div class="row">
              ...
              <!-- Bags -->
              <div class="col-sm-4">
                <article> <img class="img-responsive" src="{{ URL::asset('web/images/belleza.jpg')}}" alt="">
                  <h6>Belleza</h6>
              ...
              <!-- Women -->
              <div class="col-sm-4">
                <article> <img class="img-responsive" src="{{ URL::asset('web/images/saludbinestar.jpg')}}" alt="">
              ...
              <!-- Bags -->
              <div class="col-sm-4">
                <article> <img class="img-responsive" src="{{ URL::asset('web/images/mascotas.jpg')}}" alt="">
                  <h6>Mascotas</h6>
                  <a href="#." class="btn by">Ingresa Ahora</a>
                </article>
              </div>
              ...
              <!-- Fashion -->
              <div class="col-sm-4">
                <article> <img class="img-responsive" src="{{ URL::asset('web/images/MuestrasGratis.jpg')}}" alt="">
                  <h6>Membresia</h6>
                  <a href="#." class="btn by">Ingresa Ahora</a>
                </article>
              </div>
              ...
              <!-- Bags 
            <div class="col-sm-4">
              <article> <img class="img-responsive" src="{{ URL::asset('web/images/access-img-4.jpg')}}" alt="" >
                <h6>Accessories</h6>
          ...
          <div class="col-md-6">
            ...
            <div class="images-slider">
              <ul class="slides">
                ...
                <!-- <li data-thumb="images/item-img-1-1.jpg"> <img src="{{ URL::asset('web/images/item-img-1-1.jpg')}}" alt=""> </li>-->
              </ul>
            </div>
          </div>
      ...
      <div class="knowledge-share">
        <ul class="row">
          ...
          <li class="col">
            ...
            <!-- Post Img -->
            <div class="img-por"> <img src="{{ URL::asset('web/images/ToshComment.jpg')}}" alt=""></div>
            <article>
              <!-- Date And comment -->
              <div class="date"> <span class="huge">10</span> <span>Enero</span></div>
              <div class="com-sec"> <span><strong><a href="#."></a></strong></span> <span><strong><a
                      href="#."></a></strong></span> </div>
              <div class="clearfix"></div>
              <a href="#." class="b-tittle">Galleta Tosh Kiwi</a>
              <p>Produto muy buen sabor y saludable, lo recibi en el tiempo estimado!!!! <a href="#."></a></p>
            </article>
          </li>
          ...
          <li class="col">
            ...
            <!-- Post Img -->
            <div class="img-por"> <img src="{{ URL::asset('web/images/BacHumanComment.jpg')}}" alt=""></div>
            <article>
              <!-- Date And comment -->
          ...
          <li class="col">
            <!-- Post Img -->
            <div class="img-por"> <img src="{{ URL::asset('web/images/PetysComment.jpg')}}" alt=""></div>
            <article>
              <!-- Date And comment -->
              ...
              <p>Le encanto a mi mascota, tan pronto lo acabe, lo comprare. Me llego en optimas condiciones<a href="#."></a></p>
            </article>
          </li>
        </ul>
      </div>
